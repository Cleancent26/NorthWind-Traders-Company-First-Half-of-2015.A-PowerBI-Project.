<img width="663" alt="northwind traders company logo" src="https://github.com/user-attachments/assets/2a3221ec-759c-4f80-96c1-5cf1ae60e920">
...
### Task
##### You are to work with the Northwind Traders Data provided. It's also expected that you come up with a 2-page interactive report showing insights that answers the broad problem statement above. Each page can be about a single topic (e.g., Page 1: Customer Behavior, Page 2: Product Performance)
...
### Data Visualization
##### In the visualization of this analyzed data, I made use of several chart tools in the visualization process, among which are; stacked bar chart, stacked area chart and pie chart.
##### stacked area chart was used to visualized the monthly purchasing power while stacked bar chart was used  to visualize cities purchasing ppower,countries countribution to Northwind traders company revenue,revenue generated by companies and also the revenue contribution by contact title while pie chart was used to analyzed what categories of product received the highest order which inturns also stands as the products that keeps customers coming back.
<img width="674" alt="image" src="https://github.com/user-attachments/assets/d2196d80-fae8-495e-9969-bdb1123eaa51">
...
##### From the analysis in the product table, one could see the various products that are of high demand and as such those are the products that keeps the customers coming back and their availabity should be ensured so as not give rooms to customers to sort for such products anywhere. and it could also been seen that beverages has the highest number of orders and as such stands out as the product category that keeps customers coming back.
<img width="674" alt="image" src="https://github.com/user-attachments/assets/a026e12d-9bc8-46ed-b9ac-58fb823a31ad">
